...
#define FN 4
double face[FN][3];
double del, coef, al0, zeta1, zeta2, zeta3, ww1, rp0, rp1;
double miijj;
			...
			for (k = 0; k <= ndmz; k++)
			{
				...
				for (n1 = 1; n1 <= phiNum[i][j][k]; n1++)
				{
					...
					for (n2 = 1; n2 <= phiNum[i][j][k]; n2++)
					{
						...
						if (anij[ii][jj] == 2.0 && phiabs2ii != 0.0)
						{
							...
							if (min_idx == 0 && min_val < 90.0 / ww1 / 180.0 * PI)
							{
								miijj = mij[ii][jj] * (zeta1 + (1 - zeta1) * sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1) * tanh(1.0 / sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1)));
							}
							else if (min_idx <= 6 && min_val < 90.0 / ww1 / 180.0 * PI)
							{
								miijj = mij[ii][jj] * (zeta2 + (1 - zeta2) * sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1) * tanh(1.0 / sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1)));
							}
							else if (min_idx >= 7 && min_val < 90.0 / ww1 / 180.0 * PI)
							{
								miijj = mij[ii][jj] * (zeta3 + (1 - zeta3) * sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1) * tanh(1.0 / sqrt(pow(tan(ww1 * min_val), 2.0) + rp1 * rp1)));
							}
							else
							{
								miijj = mij[ii][jj];
