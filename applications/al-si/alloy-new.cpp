...
int main()
{
	...
	std::cout << "diffusion stability for phi: " << dtime * mobi * gt0 << std::endl;
...
start:;
	...
	// if (istep > 100 && istep % 100 == 0)
	// {
	// 	FILE *stream; // ストリームのポインタ設定
	// 	char buffer[30];
	// 	sprintf(buffer, "data/tip_vel.csv", istep);
