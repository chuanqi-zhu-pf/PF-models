...
int ni, nj, ix, iy, iz;
double sumc, c0, dc0;
double cl, dT, dT0, dd0, ll0, ml1, kap1;
double c1e, c10e;
double Dl, Ds;
double astre, astrem;
...
int main()
{
	dT = 11.0; // undercooling below melting point
	...
	dT0 = (1.0 - kap1) * dT; // solidification range ~10.0K

	gt0 = 1.7;		 // Gibbs-Thomson coefficient
	dd0 = gt0 / dT0; // Capilarity length 0.17
	dx = 2.0;
	delta = 5.0 * dx; // Interface width 10.0
	...
	std::cout << "diffusion stability for phi: " << Dl << std::endl;
	std::cout << "diffusion stability for phi: " << Ds << std::endl;
